...
*Generated by [tryappstack-audit](https://github.com/Dushyant-Khoda/tryappstack-audit) v${VERSION}*
MDHEADER
...
print_scorecard_console() {
  if [[ $TOTAL_MODS -eq 0 ]]; then return; fi

  local avg=$((TOTAL_SCORE / TOTAL_MODS))
